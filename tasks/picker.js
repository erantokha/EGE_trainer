...
import { withBuild } from '../app/build.js?v=2026-06-06-26';
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-06-06-26';
import { CONFIG } from '../app/config.js?v=2026-06-06-26';
import { supaRest } from '../app/providers/supabase-rest.js?v=2026-06-06-26';
import { loadCatalogIndexLike } from '../app/providers/catalog.js?v=2026-06-06-26';
import { listMyStudents, questionStatsForTeacherV1, protoLast3ForTeacherV1, protoLast3ForSelfV1, loadTeacherPickingScreenV2, loadTeacherPickingResolveBatchV1 } from '../app/providers/homework.js?v=2026-06-06-26';
import { pickQuestionsScopedForList } from './pick_engine.js?v=2026-06-06-26';
import { setStem } from '../app/ui/safe_dom.js?v=2026-06-06-26';
import { toAbsUrl } from '../app/core/url_path.js?v=2026-06-06-26';
import { baseIdFromProtoId } from '../app/core/pick.js?v=2026-06-06-26';
import { createSessionLink } from '../app/providers/task_session.js?v=2026-06-06-26';
// W2.1' Variant B: pure resolve/manifest builders extracted to a self-contained module.
import { ensurePickerManifest, loadTopicPoolForPreview, normalizeResolveReqArray, buildResolveBucketKey, getResolveRowBucketKey } from './picker_added_tasks.js?v=2026-06-06-26';
...
import {
  ...
  BADGE_COLOR_CLASSES,
} from './picker_common.js?v=2026-06-06-26';
...
} from './picker_stats.js?v=2026-06-06-26';

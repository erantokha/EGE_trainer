...
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-06-07-73';
import { CONFIG } from '../app/config.js?v=2026-06-07-73';
import { supaRest } from '../app/providers/supabase-rest.js?v=2026-06-07-73';
import { loadCatalogIndexLike } from '../app/providers/catalog.js?v=2026-06-07-73';
import { listMyStudents, questionStatsForTeacherV1, protoLast3ForTeacherV1, protoLast3ForSelfV1, loadTeacherPickingScreenV2, loadTeacherPickingResolveBatchV1 } from '../app/providers/homework.js?v=2026-06-07-73';
...
import { baseIdFromProtoId } from '../app/core/pick.js?v=2026-06-07-73';
import { createSessionLink } from '../app/providers/task_session.js?v=2026-06-07-73';
// W2.1' Variant B: pure resolve/manifest builders extracted to a self-contained module.
import { ensurePickerManifest, loadTopicPoolForPreview, normalizeResolveReqArray, buildResolveBucketKey, getResolveRowBucketKey } from './picker_added_tasks.js?v=2026-06-07-73';
...
import {
  ...
  BADGE_COLOR_CLASSES,
} from './picker_common.js?v=2026-06-07-73';
...
} from './picker_stats.js?v=2026-06-07-73';

...
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-05-29-9';
import { CONFIG } from '../app/config.js?v=2026-05-29-9';
...
import { listMyStudents, questionStatsForTeacherV1, loadTeacherPickingScreenV2, loadTeacherPickingResolveBatchV1 } from '../app/providers/homework.js?v=2026-05-29-9';
...
import { baseIdFromProtoId } from '../app/core/pick.js?v=2026-05-29-9';
import { createSessionLink } from '../app/providers/task_session.js?v=2026-05-29-9';
// W2.1' Variant B: pure resolve/manifest builders extracted to a self-contained module.
import { ensurePickerManifest, loadTopicPoolForPreview, normalizeResolveReqArray, buildResolveBucketKey, getResolveRowBucketKey } from './picker_added_tasks.js?v=2026-05-29-9';
...
import {
  ...
  BADGE_COLOR_CLASSES,
} from './picker_common.js?v=2026-05-29-9';
...
} from './picker_stats.js?v=2026-05-29-9';

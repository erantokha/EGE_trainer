...
import { applyMetricHelp as applyMetricHelpF5 } from '../app/ui/metric_help.js?v=2026-06-17-19-175652';
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-06-17-19-175652';
import { CONFIG } from '../app/config.js?v=2026-06-17-19-175652';
import { supaRest } from '../app/providers/supabase-rest.js?v=2026-06-17-19-175652';
import { loadCatalogIndexLike } from '../app/providers/catalog.js?v=2026-06-17-19-175652';
import { readStudentAnalyticsCache, writeStudentAnalyticsCache } from '../app/providers/student-analytics-cache.js?v=2026-06-17-19-175652';
import { readStudentAttemptsCache, writeStudentAttemptsCache } from '../app/providers/student-attempts-cache.js?v=2026-06-17-19-175652';
import { readTeacherPickingScreenCache, writeTeacherPickingScreenCache } from '../app/providers/teacher-picking-screen-cache.js?v=2026-06-17-19-175652';
import { listMyStudents, questionStatsForTeacherV1, protoLast3ForTeacherV1, protoLast3ForSelfV1, loadTeacherPickingScreenV2, loadTeacherPickingResolveBatchV1, loadStudentPickingSnapshotV1 } from '../app/providers/homework.js?v=2026-06-17-19-175652';
// WPS.1: локальный движок фильтр-подбора от «витрины» (pure, parity с серверным resolve).
import { resolveBatchLocal } from '../app/core/pick_filtered.js?v=2026-06-17-19-175652';
...
import { navigate, reserveTab, commitNavigation } from '../app/ui/nav.js?v=2026-06-17-19-175652';
import { toAbsUrl } from '../app/core/url_path.js?v=2026-06-17-19-175652';
import { baseIdFromProtoId } from '../app/core/pick.js?v=2026-06-17-19-175652';
import { createSessionLink } from '../app/providers/task_session.js?v=2026-06-17-19-175652';
// W2.1' Variant B: pure resolve/manifest builders extracted to a self-contained module.
import { ensurePickerManifest, loadTopicPoolForPreview, normalizeResolveReqArray, buildResolveBucketKey, getResolveRowBucketKey } from './picker_added_tasks.js?v=2026-06-17-19-175652';
...
import {
  ...
  BADGE_COLOR_CLASSES,
} from './picker_common.js?v=2026-06-17-19-175652';
...
} from './picker_stats.js?v=2026-06-17-19-175652';

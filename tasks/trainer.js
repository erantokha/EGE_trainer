...
import { insertAttempt } from '../app/providers/supabase-write.js?v=2026-06-18-8-182354';
import { uniqueBaseCount, sampleKByBase, computeTargetTopics, interleaveBatches } from '../app/core/pick.js?v=2026-06-18-8-182354';
import {
...
import { loadSmartMode, saveSmartMode, clearSmartMode, ensureSmartDefaults, isSmartModeActive } from './smart_mode.js?v=2026-06-18-8-182354';

import { questionStatsForTeacherV1 } from '../app/providers/homework.js?v=2026-06-18-8-182354';
import { pickProtosByPriority } from './pick_priority.js?v=2026-06-18-8-182354';
...
import { safeEvalExpr } from '../app/core/safe_expr.mjs?v=2026-06-18-8-182354';
import { isPart2Question, renderPart2Stem, buildPart2EtalonBlock, buildPart2SelfScore, typesetEl } from './part2_render.js?v=2026-06-18-8-182354';
import { submitPart2SelfScore } from '../app/providers/part2.js?v=2026-06-18-8-182354';
import { setStem } from '../app/ui/safe_dom.js?v=2026-06-18-8-182354';
import { registerStandardPrintPageLifecycle } from '../app/ui/print_lifecycle.js?v=2026-06-18-8-182354';
import { getSession } from '../app/providers/supabase.js?v=2026-06-18-8-182354';
import { supaRest } from '../app/providers/supabase-rest.js?v=2026-06-18-8-182354';
import { confirmFinish } from '../app/ui/confirm_finish.js?v=2026-06-18-8-182354';

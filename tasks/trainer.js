...
import { insertAttempt } from '../app/providers/supabase-write.js?v=2026-03-06-2';
import { uniqueBaseCount, sampleKByBase, computeTargetTopics, interleaveBatches } from '../app/core/pick.js?v=2026-03-06-2';
import { toAbsUrl } from '../app/core/url_path.js?v=2026-03-06-2';

import { loadSmartMode, saveSmartMode, clearSmartMode, ensureSmartDefaults, isSmartModeActive } from './smart_mode.js?v=2026-03-06-2';

import { questionStatsForTeacherV1 } from '../app/providers/homework.js?v=2026-03-06-2';
import { pickProtosByPriority } from './pick_priority.js?v=2026-03-06-2';
import { pickQuestionsScopedForList } from './pick_engine.js?v=2026-03-06-2';


import { withBuild } from '../app/build.js?v=2026-03-06-2';
import { hydrateVideoLinks, wireVideoSolutionModal } from '../app/video_solutions.js?v=2026-03-06-2';
import { safeEvalExpr } from '../app/core/safe_expr.mjs?v=2026-03-06-2';

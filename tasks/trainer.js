...
import { uniqueBaseCount, sampleKByBase, computeTargetTopics, interleaveBatches } from '../app/core/pick.js?v=2026-03-06-3';
import { toAbsUrl } from '../app/core/url_path.js?v=2026-03-06-3';

import { loadSmartMode, saveSmartMode, clearSmartMode, ensureSmartDefaults, isSmartModeActive } from './smart_mode.js?v=2026-03-06-3';

import { questionStatsForTeacherV1 } from '../app/providers/homework.js?v=2026-03-06-3';
import { pickProtosByPriority } from './pick_priority.js?v=2026-03-06-3';
import { pickQuestionsScopedForList } from './pick_engine.js?v=2026-03-06-3';

...
import { CONFIG } from '../app/config.js?v=2026-04-01-5';
import { getHomeworkByToken, startHomeworkAttempt, submitHomeworkAttempt, getHomeworkAttempt, normalizeStudentKey } from '../app/providers/homework.js?v=2026-04-01-5';
import { supabase, getSession } from '../app/providers/supabase.js?v=2026-04-01-5';
import { supaRest } from '../app/providers/supabase-rest.js?v=2026-04-01-5';
import { hydrateVideoLinks, wireVideoSolutionModal } from '../app/video_solutions.js?v=2026-04-01-5';
import { loadCatalogIndexLike } from '../app/providers/catalog.js?v=2026-04-01-5';

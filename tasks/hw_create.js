...
import { createHomework, createHomeworkLink, listMyStudents, assignHomeworkToStudent } from '../app/providers/homework.js?v=2026-06-18-12-195748';
...
import {
  ...
  sampleKByBase,
  interleaveBatches,
} from '../app/core/pick.js?v=2026-06-18-12-195748';
...
async function enforceTeacherGate() {
  ...
  let role = '';
  try {
    const rMod = await import('../app/providers/supabase-rest.js?v=2026-06-18-12-195748');

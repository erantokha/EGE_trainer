...
import { createHomework, createHomeworkLink, listMyStudents, assignHomeworkToStudent } from '../app/providers/homework.js?v=2026-06-18-21-223122';
...
import {
  ...
  sampleKByBase,
  interleaveBatches,
} from '../app/core/pick.js?v=2026-06-18-21-223122';
...
async function enforceTeacherGate() {
  ...
  let role = '';
  try {
    const rMod = await import('../app/providers/supabase-rest.js?v=2026-06-18-21-223122');

...
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-02-18-4';
import { createHomework, createHomeworkLink, listMyStudents, assignHomeworkToStudent } from '../app/providers/homework.js?v=2026-02-18-4';
import {
  baseIdFromProtoId,
  uniqueBaseCount,
  sampleKByBase,
  interleaveBatches,
} from '../app/core/pick.js?v=2026-02-18-4';

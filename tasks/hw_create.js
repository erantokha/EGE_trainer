...
import { supabase, getSession, signInWithGoogle, signOut, finalizeOAuthRedirect } from '../app/providers/supabase.js?v=2026-01-24-1';
import { createHomework, createHomeworkLink } from '../app/providers/homework.js?v=2026-01-24-1';
import {
  baseIdFromProtoId,
  uniqueBaseCount,
  sampleKByBase,
  interleaveBatches,
} from '../app/core/pick.js?v=2026-01-24-1';

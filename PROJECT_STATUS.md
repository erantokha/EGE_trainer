...
- параллельно W1 открыт продуктовый трек **WS — Session Links** (2026-05-13): уникальные URL-ссылки на тренажёр/список задач с замороженным набором. План — `WS_session_links_PLAN.md`. Подволна `WS.1` в работе; не сдвигает критический путь W1. Подробности — `GLOBAL_PLAN.md §6.1`.

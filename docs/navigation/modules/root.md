...
- актуальная входная точка: /index.html (корень домена). Она подключает модули из /tasks и инициализирует общий header.
- /tasks/index.html может оставаться как legacy-страница (если ранее сайт жил в /tasks), но как основную точку входа её лучше не использовать.

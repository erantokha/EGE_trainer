...
| --- | --- | --- | --- |
| `subtopic_coverage_for_teacher_v1` | `tasks/student.js` | критичен для teacher coverage и уже участвует в migration path к layer 4 | `docs/supabase/subtopic_coverage_for_teacher_v1.sql` |
...
- все три функции имеют SQL-файлы в git
...
- сначала `subtopic_coverage_for_teacher_v1`
- затем `teacher_type_rollup_v1`

...
- homework-domain SQL-gap закрыт; следующий практический фокус — auth/profile и teacher-management хвост (`auth_email_exists`, `update_my_profile`, `delete_my_account`, `add_student_by_email`, `remove_student`, `list_student_attempts`)
